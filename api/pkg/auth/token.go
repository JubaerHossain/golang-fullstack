...
func CreateTokens(userId uint, role uint, app *app.App, refreshExp uint) (string, string, error) {
...
func ValidateToken(tokenString string, app *app.App) (jwt.MapClaims, error) {
	secretKey := app.Config.JwtSecretKey
	if secretKey == "" {
		secretKey = "your-secret"
	}
